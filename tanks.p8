...
function _init()
	...
	p={
		...
		shot = {
			...
			child = {
				name = shot_types.pixel.name,
				spr = shot_types.pixel.spr,
				modifiers = {
				},
				child = nil
			}
...
-->8
-- todo
-- currently working on: bouncing shot
...

__map__
